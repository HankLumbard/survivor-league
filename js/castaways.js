...
const SURVIVOR_51_CAST = [
  { id: "aaliyah-puglia",     name: "Aaliyah",                     age: 24, hometown: "Providence, RI",       occupation: "Chef",
  ...
  { id: "alexis-levine",      name: "Alexis",                      age: 34, hometown: "Atlanta, GA",          occupation: "Criminal Defense Attorney",
    photo: "https://parade.com/.image/ODowMDAwMDAwMDAyMzMwMzgz/alexis-levine.jpg?profile=w2560&x=50&y=50" },
  { id: "thien-an-nguyen",    name: "Thien An",     age: 24, hometown: "Fort Worth, TX",       occupation: "Medical Student",
  ...
  { id: "ana-sani",           name: "Ana",                           age: 34, hometown: "Toronto, ON",          occupation: "Voice Actress",
    photo: "https://cbs6albany.com/resources/media2/16x9/1280/800/center/80/eb9e90cc-9964-4fca-bd9d-2940d1ef72eb-AnaSani.png" },
  { id: "jelly-loblack",      name: "Jelly", age: 29, hometown: "Bloomington, IN",      occupation: "Sociology Professor",
  ...
  { id: "rob-antonson",       name: "Rob",                       age: 40, hometown: "Cumberland, RI",       occupation: "Airline Gate Agent",
    photo: "https://cbs6albany.com/resources/media2/16x9/1280/800/center/80/12b3ddb4-fc45-49e2-aa40-9234adf28d25-RobAntonson.png" },
  { id: "brady-booker",       name: "Brady",                       age: 27, hometown: "Knoxville, TN",        occupation: "\"Pro\" Wrestler",
    photo: "https://cbs6albany.com/resources/media2/16x9/1280/800/center/80/05d9ecae-69eb-46d0-a6c3-e24daa6a1c28-BradyBooker.png" },
  { id: "patt-cannaday",      name: "Patt",                      age: 33, hometown: "Washington, D.C.",     occupation: "Federal Prosecutor (NARC)",
  ...
  { id: "linnea-capobianco",  name: "Linnea",                  age: 25, hometown: "Jersey City, NJ",      occupation: "Toy Sales",
  ...
  { id: "cristian-chavez",    name: "Christian",                    age: 26, hometown: "Salt Lake City, UT",   occupation: "Head of HR (Enemy-always)",
  ...
  { id: "sharonda-cox",       name: "Sharonda",                       age: 34, hometown: "Richmond, KY",         occupation: "Tribe Gyno",
    photo: "https://cbs6albany.com/resources/media2/16x9/1280/800/center/80/bbb97a5d-5cdf-4728-9fa6-a196321f18a9-SharondaCox.png" },
  { id: "jenna-doore",        name: "Jenna",                        age: 30, hometown: "Toledo, OH",           occupation: "Wedding Photographer?",
    photo: "https://cbs6albany.com/resources/media2/16x9/1280/800/center/80/06d841bb-cf45-4d48-8483-4351aa7cc147-JennaDoore.png" },
  { id: "kristin-flickinger", name: "Kristin",                 age: 49, hometown: "Santa Barbara, CA",    occupation: "Crisis Management",
  ...
  { id: "ori-jean-charles",   name: "Ori",                   age: 27, hometown: "Spring Valley, NY",    occupation: "Personal Trainer",
  ...
  { id: "maggie-nestor",      name: "Maggie",                      age: 40, hometown: "Charles Town, WV",     occupation: "Farmer",
  ...
  { id: "mike-pinsky",        name: "Mike",                        age: 32, hometown: "New York, NY",         occupation: "Baseball Operations Executive",
    photo: "https://cbs6albany.com/resources/media2/16x9/1280/800/center/80/76003c77-5106-4a3f-b7df-ad0971aad662-MikePinsky.png" },
  { id: "devin-way",          name: "Devin",                          age: 33, hometown: "Los Angeles, CA",      occupation: "Actor",
